...
config.vendor_path_css=[
	...
	config.bower_path+'/bootstrap/dist/js/bootstrap-theme.min.css'
];
...
gulp.task('copy-styles',function(){
	//elixir(function(mix){
	//		mix.sass(config.assets_path+'/css/app.scss',config.assets_path+'/css');
	//	});
	gulp.src([
...
gulp.task('default',['clean-build-folder'],function(){
	...
	elixir(function(mix) {
	    ...
	    mix.scripts(config.vendor_path_js.concat([config.assets_path+'/js/**/*.js']),
	    	'public/css/all.js',config.assets_path);
